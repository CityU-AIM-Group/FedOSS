...
"""
import torch
from .communication import communication_FedOSR
from .common import setup, update_lr
from .DUS_baseline_library import train, val, test
...
def run(args):
    ...
    for epoch_it in range(args.epoches // args.worker_steps):        
        ...
        server_model, models = communication_FedOSR(args, server_model, models, client_weights)
